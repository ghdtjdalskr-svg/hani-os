...
const FORMAT = "HANI_MODULAR_RELEASE_PACKAGE_V1";
...
if (command === "build") {
  ...
  const pkg = { format: FORMAT, label: option("--label", `HANI OS ${candidateSha.slice(0, 12)}`), release_notes: option("--notes", "Candidate runtime closure snapshot"), base_main_sha: baseSha, candidate_sha: candidateSha, package_sha256: hash.package_sha256, files };
  ...
  if (pkg.format !== FORMAT || !Array.isArray(pkg.files)) throw new Error("Invalid modular package format.");
