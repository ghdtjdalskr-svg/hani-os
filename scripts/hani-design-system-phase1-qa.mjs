...
const output=resolve(process.env.HANI_PHASE1_QA_OUTPUT||join(tmpdir(),'hani-design-system-phase1-v29131'));
...
const report={version:'2.9.131',base:'origin/main@f29aa2b31909d22261e9c91a9a83dcc9bc24e3a4',generatedAt:new Date().toISOString(),viewports:[],invariants:{}};
...
try{
  ...
  assert.equal(report.invariants.displayVersion,'2.9.131');
